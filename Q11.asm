# Question 11 - Project 1 Lab CS
# Purpose: Program that counts how many words that greater than zero
# How many positive numbers are in array A

.data
A: .space 24 # Array of 6 words (each word contains 4 bytes)
next_line: .asciiz "\n"
out_msg: .asciiz "Number of words greater than zero: "
...
ble $a1,$0,continue # If $a1(A[i]) <= 0 jump to label 
...
la $a0,out_msg # Load Address: load address of $a0 to the string out_msg
