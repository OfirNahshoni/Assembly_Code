# Question 5 - Project 1 Lab CS
# Purpose: Program that finds the maximum value in array A and display it
# to Run I/O screen

.data
A: .space 24 # Specify length of array A: 6 words array (6*4)
next_line: .asciiz "\n"
out_str: .asciiz "The maximum number is: "
...
beq $t6,$0,continue # If $t6=0 ($t3>=$t5) jump to label continue
add $t3,$0,$t5 # Set $t3=$t5
continue:
addi $t0,$t0,4 # i=i+4
j find_max # Jump to label find_max
